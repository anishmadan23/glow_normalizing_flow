...
class CelebA(Dataset):
    ...
    def __init__(self, root, train=True, transform=None, mini_data_size=None):
        self.root = os.path.join(root, self.__class__.__name__)
        ...
        # print('dloader data shape',len(data['train']),data['train'][0])
        if train:
...
if __name__ == '__main__':
    # d = CelebA('~/Data/')
    d = CelebA('/media/tiwari/My Passport/lokender/anish/normalizing_flows/datasets/data/')
    ...
    d_ = CelebA('/media/tiwari/My Passport/lokender/anish/normalizing_flows/datasets/data/', transform=t)
